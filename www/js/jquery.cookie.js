...
<html lang="en">
  ...
  <meta property="fb:app_id" content="1401488693436528">
    ...
    <meta property="og:image" content="https://avatars2.githubusercontent.com/u/21918?s=400&amp;v=4" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="carhartl/jquery-cookie" /><meta property="og:url" content="https://github.com/carhartl/jquery-cookie" /><meta property="og:description" content="jquery-cookie - No longer maintained, superseded by JS Cookie:" />

  <link rel="assets" href="https://assets-cdn.github.com/">
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjczNzE0Mzg5OjNlYWJmZDEzYzQzMGNiMGUxNjlmZTMzZDEyY2QyZTZkYzRhNzI3ZDQ3MzYyMGU3OTgwMDk5NDRiZTc4NWU3NjI=--304eded43eb2e9b9d3c2c8da9fa85b566f2dc857">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="1E24:0AD1:4CADA:6F73C:5AF1002E" data-pjax-transient>
...
<meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="1E24:0AD1:4CADA:6F73C:5AF1002E" /><meta name="octolytics-dimension-region_edge" content="ap-southeast-1" /><meta name="octolytics-dimension-region_render" content="iad" /><meta name="octolytics-actor-id" content="15242117" /><meta name="octolytics-actor-login" content="Motatocity" /><meta name="octolytics-actor-hash" content="5602273491906a7ce3e0b0463da29f4ae9d264716029af05144e18801fbcd344" />
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="Motatocity">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="NWI4YWY5NjIxOGNmMTU4ZTk2N2NjNjQ0OWYxYjE5NWY0OWVkODMxNWY1YTYwYTY0YjQ3Y2I0ZmQ3NTVhMTY4N3x7InJlbW90ZV9hZGRyZXNzIjoiMTgzLjg5LjIwMC4yNDMiLCJyZXF1ZXN0X2lkIjoiMUUyNDowQUQxOjRDQURBOjZGNzNDOjVBRjEwMDJFIiwidGltZXN0YW1wIjoxNTI1NzQzNjcxLCJob3N0IjoiZ2l0aHViLmNvbSJ9">
  ...
  <meta name="html-safe-nonce" content="9bec0a3f1bd98ea521c35d73bf23ee75bbfca5df">
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="268027" data-scoped-search-url="/carhartl/jquery-cookie/search" data-unscoped-search-url="/search" action="/carhartl/jquery-cookie/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
    <label class="form-control header-search-wrapper  js-chromeless-input-container">
          <a class="header-search-scope no-underline" href="/carhartl/jquery-cookie/blob/master/src/jquery.cookie.js">This repository</a>
      <input type="text"
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown js-menu-container">
    ...
    <a aria-label="You have unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:unread" data-channel="notification-changed:15242117" href="/notifications">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@Motatocity" class="avatar float-left mr-1" src="https://avatars3.githubusercontent.com/u/15242117?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">Motatocity</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/Motatocity" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/Motatocity?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="SAm874yYEEdZtZz+kfpGIdBJrNDG5X//TNuoXcaaBDGCXvcmZLn+u15rF+NuNxermy3PgbrG0JJqjA0bUjDVwQ==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="A+MpPqF/3gIfHdJtR5QWUqiOxY0J7xR6DGo8xtNwEGDJtGL3SV4w/hjDWXC4WUfY4+qm3HXMuxcqPZmAR9rBkA==" />
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="dSkOmlC/TONR9prb+7aqDGZfyAD2cF6DrJJBLLaWcq7iaQ5ogrW+9dlrFwe3LVUJ8DPSklgGz7KBEhTxg7Cjpw==" />      <input type="hidden" name="repository_id" id="repository_id" value="268027" class="form-control" />
        ...
        <div class="select-menu js-menu-container js-select-menu">
          ...
          <a class="social-count js-social-count"
            ...
            aria-label="460 users are watching this repository">
            460
          </a>
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/carhartl/jquery-cookie/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="0gsoB30TuNBpxca+n4PSPYhk00M4+rOBmGs8Ev30B3rtdifXsBJ+xKq6TWL5aXMGgH23f6ASGeby57mJP/thrg==" />
      ...
      <button
        ...
        <a class="social-count js-social-count" href="/carhartl/jquery-cookie/stargazers"
           aria-label="8479 users starred this repository">
          8,479
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/carhartl/jquery-cookie/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="G0CZInLWU5VtiyzNwT1wUvpIX1AHlxwEtju0qEuZh1oFe76UfMuxWvK1k7rVpZ5XI7cFXjstcZoXdmx/fkx1+g==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/carhartl/jquery-cookie/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="nuTq7f/C8fI75LDXu0cxexMcgsRhzTORTt1tsvtH5bvMHUBMidYC0PKBdGAhgkvQgHMWohYIYjjdwkA8woHG8w==" />
            <button
                type="submit"
  ...
  <span class="author" itemprop="author"><a class="url fn" rel="author" href="/carhartl">carhartl</a></span><!--
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a class="js-selected-navigation-item selected reponav-item" itemprop="url" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /carhartl/jquery-cookie" href="/carhartl/jquery-cookie">
  ...
  <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse /carhartl/jquery-cookie/pulse" href="/carhartl/jquery-cookie/pulse">
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="commit-tease">
      ...
      <div>
        <img alt="@carhartl" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/21918?s=40&amp;v=4" width="20" />
...
Closes #336.">Fix removing cookies in sub paths</a>
      ...
      <button type="button" class="btn-link muted-link contributors-toggle" data-facebox="#blob_contributors_box">
        <strong>4</strong>
         contributors
          ...
          <a class="avatar-link tooltipped tooltipped-s" aria-label="carhartl" href="/carhartl/jquery-cookie/commits/master/src/jquery.cookie.js?author=carhartl"><img alt="@carhartl" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/21918?s=40&amp;v=4" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="t0mtaylor" href="/carhartl/jquery-cookie/commits/master/src/jquery.cookie.js?author=t0mtaylor"><img alt="@t0mtaylor" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/975744?s=40&amp;v=4" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="Krinkle" href="/carhartl/jquery-cookie/commits/master/src/jquery.cookie.js?author=Krinkle"><img alt="@Krinkle" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/156867?s=40&amp;v=4" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="kvaggelakos" href="/carhartl/jquery-cookie/commits/master/src/jquery.cookie.js?author=kvaggelakos"><img alt="@kvaggelakos" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/1001352?s=40&amp;v=4" width="20" /> </a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list" data-facebox-id="facebox-description">
          ...
          <li class="facebox-user-list-item">
            <img alt="@t0mtaylor" height="24" src="https://avatars1.githubusercontent.com/u/975744?s=48&amp;v=4" width="24" />
          ...
          <li class="facebox-user-list-item">
            <img alt="@kvaggelakos" height="24" src="https://avatars2.githubusercontent.com/u/1001352?s=48&amp;v=4" width="24" />
            <a href="/kvaggelakos">kvaggelakos</a>
          </li>
      </ul>
    </div>
  </div>
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" href="/carhartl/jquery-cookie/blame/d72bb07e29962330db61aae1eda07f6312419840/src/jquery.cookie.js">View git blame</a></li>
      </ul>
    </div>
  </div>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.36482s from unicorn-482936876-s8h8b">GitHub</span>, Inc.</li>
